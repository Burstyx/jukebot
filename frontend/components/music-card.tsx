...
export default function MusicCard(props: Props) {
    ...
    async function addMusicToQueue() {
        ...
        toast.success(`Ajouté à la file`, { description: decodeURI(props.music.name) });
    }
            ...
            <ContextMenuTrigger>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Card className="p-2 border-2 max-w-[350px] cursor-pointer hover:bg-accent transition-colors duration-[.1s]" onClick={addMusicToQueue}>
